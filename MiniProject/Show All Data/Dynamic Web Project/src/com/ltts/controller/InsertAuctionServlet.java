...
public class InsertAuctionServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		int aid=Integer.parseInt(request.getParameter("auctionno"));
		int pid=Integer.parseInt(request.getParameter("playerno"));
		int tid=Integer.parseInt(request.getParameter("teamno"));
